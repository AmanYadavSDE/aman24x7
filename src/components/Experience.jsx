      ...
      <div className="container-max">
        ...
        >
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary-400 to-accent-400 hidden md:block"></div>
            ...
            <div className="space-y-12">
              {experiences.map((exp, index) => (
                ...
                >
                  {/* Timeline Dot */}
                  <div className="absolute -left-24 top-6 w-4 h-4 bg-gradient-to-r from-primary-400 to-accent-400 rounded-full hidden md:block">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 text-gray-300 mb-2">
                          <div className="flex items-center">
                            <HiOfficeBuilding className="mr-2 text-primary-400" />
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.technologies.map((tech, i) => (
                          <span
                            key={i}
                            className="px-3 py-1 bg-gradient-to-r from-primary-600/20 to-accent-600/20 border border-primary-500/30 rounded-full text-sm text-white"
                          >
                            {tech}
                          </span>
                        ))}
